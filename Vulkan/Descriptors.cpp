...
namespace Vulkan
{
  ...
  std::vector<VkDescriptorSetLayout> Descriptors_impl::GetDescriptorSetLayouts() const
  {
  ...
  std::vector<VkDescriptorSet> Descriptors_impl::GetDescriptorSets() const
  {
  ...
  Descriptors &Descriptors::operator=(const Descriptors &obj)
  {
    ...
    if (auto er = impl->BuildAllSetLayoutConfigs(); er != VK_SUCCESS)
    {
