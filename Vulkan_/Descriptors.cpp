...
namespace Vulkan
{
  ...
  Descriptors_impl::~Descriptors_impl()
  {
    Logger::EchoDebug("", __func__);
    Destroy();
  }

  void Descriptors_impl::Destroy()
  {
  ...
  DescriptorType DescriptorInfo::MapStorageType(StorageType type)
  {
    switch (type)
    {
  ...
  DescriptorSetLayout Descriptors_impl::CreateDescriptorSetLayout(const LayoutConfig &info)
  {
  ...
  VkResult Descriptors_impl::CreateDescriptorSets(const VkDescriptorPool pool, DescriptorSetLayout &layout)
  {
  ...
  VkResult Descriptors_impl::UpdateDescriptorSet(const DescriptorSetLayout &layout, const LayoutConfig &info)
  {
  ...
  VkResult Descriptors_impl::AddSetLayoutConfig(const LayoutConfig &config)
  {
  ...
  VkResult Descriptors_impl::BuildAllSetLayoutConfigs()
  {
    std::lock_guard lock(build_mutex);
    PoolConfig conf;
  ...
  void Descriptors_impl::ClearAllSetLayoutConfigs()
  {
    std::lock_guard lock(build_mutex);
    build_config.clear();
  }

  std::vector<VkDescriptorSetLayout> Descriptors_impl::GetDescriptorSetLayouts()
  {
  ...
  std::vector<VkDescriptorSet> Descriptors_impl::GetDescriptorSets()
  {
  ...
  Descriptors &Descriptors::operator=(const Descriptors &obj)
  {
  ...
  Descriptors::Descriptors(const Descriptors &obj)
  {
    if (obj.impl.get() == nullptr)
    {
      Logger::EchoError("Object is empty", __func__);
