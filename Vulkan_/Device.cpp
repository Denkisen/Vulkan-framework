...
namespace Vulkan
{
  ...
  VkDeviceSize Device_impl::GetPhisicalDevicesCount() noexcept
  {
  ...
  std::vector<VkPhysicalDevice> Device_impl::GetAllPhysicalDevices() noexcept
  {
  ...
  std::vector<std::string> Device_impl::GetPhysicalDeviceExtensions(const VkPhysicalDevice &device) noexcept
  {
    uint32_t count = 0;
  ...
  std::vector<Queue> Device_impl::FindFamilyQueues() const noexcept
  {
  ...
  Device_impl::Device_impl(const DeviceConfig params) noexcept
  {
    try 
    {
  ...
  VkDevice Device_impl::Create(const VkPhysicalDeviceFeatures features) noexcept
  {
  ...
  VkQueue Device_impl::GetGraphicQueue() const noexcept
  {
    if (queue_flag_bits == QueueType::DrawingType || queue_flag_bits == QueueType::DrawingAndComputeType)
    {
      for (auto &q : queues)
  ...
  VkQueue Device_impl::GetPresentQueue() const noexcept
  {
    if (queue_flag_bits == QueueType::DrawingType || queue_flag_bits == QueueType::DrawingAndComputeType)
    {
      for (auto &q : queues)
  ...
  VkQueue Device_impl::GetComputeQueue() const noexcept
  {
  ...
  std::optional<uint32_t> Device_impl::GetGraphicFamilyQueueIndex() const noexcept
  {
  ...
  std::optional<uint32_t> Device_impl::GetPresentFamilyQueueIndex() const noexcept
  {
    std::optional<uint32_t> ret;
    if (queue_flag_bits == QueueType::DrawingType || queue_flag_bits == QueueType::DrawingAndComputeType)
    {
  ...
  std::optional<uint32_t> Device_impl::GetComputeFamilyQueueIndex() const noexcept
  {
    std::optional<uint32_t> ret;
  ...
  VkFormatProperties Device_impl::GetFormatProperties(const VkFormat format) const noexcept
  {
  ...
  VkQueue Device_impl::GetQueueFormFamilyIndex(const uint32_t index) const noexcept
  {
    VkQueue q;
  ...
  Device &Device::operator=(const Device &obj) noexcept
  {
  ...
  Device::Device(const Device &obj) noexcept
  {
    DeviceConfig conf;
    conf.SetDeviceIndex(obj.impl->p_device.device_index);
    conf.SetDeviceType((PhysicalDeviceType) obj.impl->p_device.device_properties.deviceType);
