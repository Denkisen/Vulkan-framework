...
namespace Vulkan
{
  ...
  ImageArray_impl::ImageArray_impl(const std::shared_ptr<Device> dev) noexcept
  {
  ...
  VkResult ImageArray_impl::StartConfig(const HostVisibleMemory val) noexcept
  {
  ...
  VkResult ImageArray_impl::AddImage(const ImageConfig &params) noexcept
  {
    std::lock_guard lock(config_mutex);
  ...
  VkResult ImageArray_impl::EndConfig() noexcept
  {
    std::lock_guard lock(config_mutex);
